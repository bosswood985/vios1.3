...
import { Users, Eye, FileText, Settings, ClipboardList, DollarSign, FolderOpen, LogOut, User } from "lucide-react";
...
export default function Layout({ children }) {
    ...
    return (
        <div className="min-h-screen flex w-full bg-gray-50">
            <div className="w-64 bg-white border-r border-gray-200 fixed left-0 top-0 h-full z-50 flex flex-col">
                        ...
                        {navigationItems.map((item) => {
                            ...
                            return (
                                <Link
                                    key={item.title}
                                    to={item.url}
                                    className={`flex items-center gap-3 px-3 py-2 rounded-lg mb-1 transition-colors duration-200 ${isActive ? 'bg-blue-50 text-blue-700' : 'hover:bg-blue-50 hover:text-blue-700'
                                        }`}
                                >
